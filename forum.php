        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="row  row-cols-9  gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <h1 class="display-5 fw-bolder text-danger"> BAPE x adidas Forum 84 Low 30th Anniversary Blue </h1>
                    <div class="fs-5 mb-5">
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="for.php">Comprar</a></div>
                        </div>
                    </div>
                </div>
                <div class="col mb-5">
