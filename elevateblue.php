    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row  row-cols-9  gx-lg-5 align-items-center">
                <div class="col-md-6">
                  <div class="col"><img class="card-img-top mb-5 mb-md-0" src="icons/French Blue/French Blue.png" alt="..." /></div>
                  
                 </div>
                <div class="col-md-6">
                    <div class="small mb-1">SKU: BST-498</div>
                    <h1 class="display-5 fw-bolder text-danger"> Air Jordan 1 Elevate LowFrench Blue </h1>
                    <div class="fs-5 mb-5">
                        <span class="text-decoration-line-through">R$ 1499,99</span>
                        <span>R$ 1249,99</span>
                    </div>
                    <p class="lead">Esteja à altura da ocasião em grande estilo. Este tênis retrabalha a magia original de um ícone com uma sola de plataforma e silhueta de corte baixo. O amortecimento a ar mantém você levantado e o couro elegante em cores contrastantes adiciona interesse visual.</p>
                    <div class="d-flex">
