    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row  row-cols-9  gx-lg-5 align-items-center">
                <div class="col-md-6">
                  <div class="col"><img class="card-img-top mb-5 mb-md-0" src="icons3/Air Jordan 1 Mid SE Flight Club/abidas2.jpg" alt="..." /></div>
                  
                 </div>
                <div class="col-md-6">
                    <div class="small mb-1">SKU: BST-498</div>
                    <h1 class="display-5 fw-bolder text-danger">Air Jordan 1 Mid SE Flight Club</h1>
                    <div class="fs-5 mb-5">
                        
                        <span>R$ 1521,93</span>
                    </div>
                    <p class="lead">Vestido com um esquema de cores Magic Ember, Sundial, White e Black. Este Air Jordan 1 Mid ostenta uma base branca e preta construída em couro com línguas de malha e forro. Sobreposições de camurça Magic Ember e Sundial com palmilhas da marca “Flight Club” no topo de uma entressola branca e sola de borracha preta completam o design.</p>
                    <div class="d-flex">
        ...
        <div class="container px-4 px-lg-5 mt-5">
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="icons2/adidas Campus/abibas3.jpg" alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
